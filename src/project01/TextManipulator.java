...
public class TextManipulator {
    ...
    public static String removeCharactersFromWords(String word) {
        ...
        for (char character : arrayWord) {
            ...
            if (((int) character != 32) && ((int) character >= 48 && (int) character <= 57) || // Numbers 0 to 9
     ...
     * 
     * @param preProcessedText Text without special characters and in lowercase
     *                         letters.
    ...
    public static ArrayList<String> textProcess(ArrayList<String> preProcessedText) {
        ...
        /*
         * Instantiate an object of OutputManager to relate each key to the related
         * words
         */
